...
# FUNCTION setVelocity(ID, vel)
# Takes ID of actuator and moving speed desired as input.
# Packet returned will suit code written by professor in actuator_sim.py
